        ...
        <main className="flex-1 flex flex-col p-6 overflow-y-auto max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-wrap items-end justify-between gap-6 mb-8">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-500 dark:text-slate-400">Manage access levels and monitor active users within the current room.</p>
            </div>
          ...
          <div className="overflow-hidden rounded-xl border border-slate-200 dark:border-primary/20 bg-white dark:bg-background-dark/30 shadow-sm">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-slate-200 dark:border-primary/10 bg-slate-50 dark:bg-primary/5">
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Showing <span className="font-bold dark:text-white">1</span> to <span className="font-bold dark:text-white">{Math.min(10, filteredMembers.length)}</span> of <span className="font-bold dark:text-white">{totalMembers.toLocaleString()}</span> members
              </p>
              <div className="flex gap-2">
                ...
                {totalMembers > 10 && (
                  <>
                    <button className="flex h-9 w-9 items-center justify-center rounded border border-slate-200 dark:border-primary/20 hover:bg-primary/10 transition-colors text-sm">2</button>
                    {totalMembers > 20 && (
                      <button className="flex h-9 w-9 items-center justify-center rounded border border-slate-200 dark:border-primary/20 hover:bg-primary/10 transition-colors text-sm">3</button>
                    )}
                    {totalMembers > 30 && (
